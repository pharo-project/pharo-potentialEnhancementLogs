...
### Sista-related
Sista is an optimizing JIT for Pharo. It is the result of multiple years of developement by Clement Bera and Eliot Miranda. An optimizing JIT is manipulating code (folding constant, rewriting it) before compiling it to assembly code. 
